...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--detect_method', default='NPR', help='detection method NPR or local_grad')
        parser.add_argument('--loss_fn', default='BCEWithLogitsLoss', help='detection method NPR or local_grad')
